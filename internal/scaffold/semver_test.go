...
func TestParseVersion(t *testing.T) {
	tests := []struct {
		...
		{"build metadata", "1.2.3+build.42", Version{1, 2, 3}, false},
		{"prerelease and build", "1.2.3-rc.1+sha.abc", Version{1, 2, 3}, false},
		{"build only with v", "v0.5.0+custom", Version{0, 5, 0}, false},
