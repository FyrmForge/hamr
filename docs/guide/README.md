# HAMR Framework Guide

Guides for every `hamr/pkg` package, ordered from foundational to advanced.

## Getting Started

1. [Config](config.md) — Environment-based configuration helpers
2. [Server](server.md) — Echo wrapper with lifecycle hooks
